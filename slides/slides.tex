...
\author{Viktor Malík \and Michal Hečko}
\institute{Red Hat}
\date{April 9, 2025}
  ...
  \begin{itemize}
    ...
    \item Basic knowledge of Git commands for:
      ...
      \setlength\itemsep{.3em}
        ...
        \item working with branches (\texttt{git switch, git branch})
...
\begin{frame}
  ...
  Your feedback is welcome!\\\texttt{https://forms.gle/iWeF7TVqW3ZrMV648}
\end{frame}
