...
\begin{frame}
  \frametitle{Using a feature branch}
  \vspace{-1em}
  The state of master after \textbf{rebase}:
  \vspace{1em}
  \begin{center}
...
\begin{frame}
  ...
  master (to avoid creation of a merge commit).
  \vspace{1em}
  \begin{center}
    \hspace{-2em}
...
\begin{frame}
  \frametitle{Copying commits from other branches}
  \vspace{-1em}
  After moving 3 commits from \textit{recursion} \textit{multiple-files}:
  \vspace{2.2em}
  \begin{center}
...
\begin{frame}
  \frametitle{Copying commits from other branches}
  \vspace{-1em}
  If the commits are altered in \textit{multiple-files}, it mey be needed to
